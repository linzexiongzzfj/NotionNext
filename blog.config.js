...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LINZEXIONG', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的银行人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://linzexiongzzfj.vercel.app', // 网站地址
